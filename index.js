...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-candy/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:' + fullname + ' --external bitcore-lib-candy -o ' + fullname + '.js';
    } else {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:bitcore-lib-candy -o bitcore-lib-candy.js';
    }
